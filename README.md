...
| Helm chart (OCI) | `oci://ghcr.io/kuvik-io/kuvik-adc/charts/kuvik-operator:0.13.0` |
| Chart tarball | [kuvik-operator-0.13.0.tgz](https://github.com/Kuvik-io/kuvik-adc/releases/download/v0.13.0/kuvik-operator-0.13.0.tgz) |
| Image tarball (airgap) | [kuvik-operator-image-0.13.0.tar.gz](https://github.com/Kuvik-io/kuvik-adc/releases/download/v0.13.0/kuvik-operator-image-0.13.0.tar.gz) |

Full release notes: [v0.13.0](https://github.com/Kuvik-io/kuvik-adc/releases/tag/v0.13.0). Earlier versions: [all releases](https://github.com/Kuvik-io/kuvik-adc/releases).
