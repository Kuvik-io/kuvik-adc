...
## Latest release: v0.13.80

| Artifact | Reference |
|---|---|
| Container image | `ghcr.io/kuvik-io/kuvik-adc/kuvik-operator:0.13.80` (also `:latest`) |
| Helm chart (OCI) | `oci://ghcr.io/kuvik-io/kuvik-adc/charts/kuvik-operator:0.13.80` |
| Chart tarball | [kuvik-operator-0.13.80.tgz](https://github.com/Kuvik-io/kuvik-adc/releases/download/v0.13.80/kuvik-operator-0.13.80.tgz) |
| Image tarball (airgap) | [kuvik-operator-image-0.13.80.tar.gz](https://github.com/Kuvik-io/kuvik-adc/releases/download/v0.13.80/kuvik-operator-image-0.13.80.tar.gz) |

Full release notes: [v0.13.80](https://github.com/Kuvik-io/kuvik-adc/releases/tag/v0.13.80). Earlier versions: [all releases](https://github.com/Kuvik-io/kuvik-adc/releases).
