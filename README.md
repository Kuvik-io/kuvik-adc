...
| Helm chart (OCI) | `oci://ghcr.io/kuvik-io/kuvik-adc/charts/kuvik-operator:0.13.2` |
| Chart tarball | [kuvik-operator-0.13.2.tgz](https://github.com/Kuvik-io/kuvik-adc/releases/download/v0.13.2/kuvik-operator-0.13.2.tgz) |
| Image tarball (airgap) | [kuvik-operator-image-0.13.2.tar.gz](https://github.com/Kuvik-io/kuvik-adc/releases/download/v0.13.2/kuvik-operator-image-0.13.2.tar.gz) |

Full release notes: [v0.13.2](https://github.com/Kuvik-io/kuvik-adc/releases/tag/v0.13.2). Earlier versions: [all releases](https://github.com/Kuvik-io/kuvik-adc/releases).
