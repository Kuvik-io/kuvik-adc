...
| Helm chart (OCI) | `oci://ghcr.io/kuvik-io/kuvik-adc/charts/kuvik-operator:0.13.1` |
| Chart tarball | [kuvik-operator-0.13.1.tgz](https://github.com/Kuvik-io/kuvik-adc/releases/download/v0.13.1/kuvik-operator-0.13.1.tgz) |
| Image tarball (airgap) | [kuvik-operator-image-0.13.1.tar.gz](https://github.com/Kuvik-io/kuvik-adc/releases/download/v0.13.1/kuvik-operator-image-0.13.1.tar.gz) |

Full release notes: [v0.13.1](https://github.com/Kuvik-io/kuvik-adc/releases/tag/v0.13.1). Earlier versions: [all releases](https://github.com/Kuvik-io/kuvik-adc/releases).
