...
| Artifact | Reference |
|---|---|
| Container image | `ghcr.io/kuvik-io/kuvik-adc/kuvik-operator:0.12.2` (also `:latest`) |
| Helm chart (OCI) | `oci://ghcr.io/kuvik-io/kuvik-adc/charts/kuvik-operator:0.12.2` |
| Chart tarball | [kuvik-operator-0.12.2.tgz](https://github.com/Kuvik-io/kuvik-adc/releases/download/v0.12.2/kuvik-operator-0.12.2.tgz) |
| Image tarball (airgap) | [kuvik-operator-image-0.12.2.tar.gz](https://github.com/Kuvik-io/kuvik-adc/releases/download/v0.12.2/kuvik-operator-image-0.12.2.tar.gz) |

Full release notes: [v0.12.2](https://github.com/Kuvik-io/kuvik-adc/releases/tag/v0.12.2). Earlier versions: [all releases](https://github.com/Kuvik-io/kuvik-adc/releases).
...
```bash
curl -fLo /tmp/op.tgz \
  https://github.com/Kuvik-io/kuvik-adc/releases/download/v0.12.2/kuvik-operator-0.12.2.tgz
curl -fLo /tmp/img.tar.gz \
  https://github.com/Kuvik-io/kuvik-adc/releases/download/v0.12.2/kuvik-operator-image-0.12.2.tar.gz
