...
## Latest release: v1.0.367

| Artifact | Reference |
|---|---|
| Container image | `ghcr.io/kuvik-io/kuvik-adc/kuvik-operator:1.0.367` (also `:latest`) |
| Helm chart (OCI) | `oci://ghcr.io/kuvik-io/kuvik-adc/charts/kuvik-operator:1.0.367` |
| Chart tarball | [kuvik-operator-1.0.367.tgz](https://github.com/Kuvik-io/kuvik-adc/releases/download/v1.0.367/kuvik-operator-1.0.367.tgz) |
| Image tarball (airgap) | [kuvik-operator-image-1.0.367.tar.gz](https://github.com/Kuvik-io/kuvik-adc/releases/download/v1.0.367/kuvik-operator-image-1.0.367.tar.gz) |

Full release notes: [v1.0.367](https://github.com/Kuvik-io/kuvik-adc/releases/tag/v1.0.367). Earlier versions: [all releases](https://github.com/Kuvik-io/kuvik-adc/releases).
...
```bash
curl -fLo /tmp/op.tgz \
  https://github.com/Kuvik-io/kuvik-adc/releases/download/v1.0.367/kuvik-operator-1.0.367.tgz
curl -fLo /tmp/img.tar.gz \
  https://github.com/Kuvik-io/kuvik-adc/releases/download/v1.0.367/kuvik-operator-image-1.0.367.tar.gz
