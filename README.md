...
## Latest release: v0.11.86

| Artifact | Reference |
|---|---|
| Container image | `ghcr.io/kuvik-io/kuvik-adc/kuvik-operator:0.11.86` (also `:latest`) |
| Helm chart (OCI) | `oci://ghcr.io/kuvik-io/kuvik-adc/charts/kuvik-operator:0.11.86` |
| Chart tarball | [kuvik-operator-0.11.86.tgz](https://github.com/Kuvik-io/kuvik-adc/releases/download/v0.11.86/kuvik-operator-0.11.86.tgz) |
| Image tarball (airgap) | [kuvik-operator-image-0.11.86.tar.gz](https://github.com/Kuvik-io/kuvik-adc/releases/download/v0.11.86/kuvik-operator-image-0.11.86.tar.gz) |

Full release notes: [v0.11.86](https://github.com/Kuvik-io/kuvik-adc/releases/tag/v0.11.86). Earlier versions: [all releases](https://github.com/Kuvik-io/kuvik-adc/releases).
...
```bash
curl -fLo /tmp/op.tgz \
  https://github.com/Kuvik-io/kuvik-adc/releases/download/v0.11.86/kuvik-operator-0.11.86.tgz
curl -fLo /tmp/img.tar.gz \
  https://github.com/Kuvik-io/kuvik-adc/releases/download/v0.11.86/kuvik-operator-image-0.11.86.tar.gz
