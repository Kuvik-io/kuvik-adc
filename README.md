...
| Helm chart (OCI) | `oci://ghcr.io/kuvik-io/kuvik-adc/charts/kuvik-operator:1.0.1` |
| Chart tarball | [kuvik-operator-1.0.1.tgz](https://github.com/Kuvik-io/kuvik-adc/releases/download/v1.0.1/kuvik-operator-1.0.1.tgz) |
| Image tarball (airgap) | [kuvik-operator-image-1.0.1.tar.gz](https://github.com/Kuvik-io/kuvik-adc/releases/download/v1.0.1/kuvik-operator-image-1.0.1.tar.gz) |

Full release notes: [v1.0.1](https://github.com/Kuvik-io/kuvik-adc/releases/tag/v1.0.1). Earlier versions: [all releases](https://github.com/Kuvik-io/kuvik-adc/releases).
